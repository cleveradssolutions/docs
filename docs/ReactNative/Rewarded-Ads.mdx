...
```ts
useEffect(() => {
  RewardedAd.setPlacement("BestPlace"); // [!code focus] 
}, []);
```
...
## Complete example
- [Rewarded ad example](https://github.com/cleveradssolutions/CAS-ReactNative/blob/main/example/src/RewardedExample.tsx)
