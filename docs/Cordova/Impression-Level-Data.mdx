...
### Tenjin
To measure ad revenue with Tenjin Analytics integrate the [Tenjin plugin](https://www.npmjs.com/package/cordova-plugin-tenjin) or just include Tenjin SDK by CAS PLugin variable:
```xml
<variable name="IOS_CAS_SOLUTIONS" value="... tenjin" />
<variable name="ANDROID_CAS_SOLUTIONS" value="... tenjin" />
```
