...
- [Enable test ad mode](Cordova/Enabling-test-ads#enable-test-ad-mode) for all devices.
- [Set device ids to test ad](Cordova/Enabling-test-ads#enable-test-devices).
...
```js
casai.setDebugLoggingEnabled(true);
```
