...
<preference name="GradlePluginKotlinVersion" value="{{ min.kotlin }}" />
```
### iOS Cordova:
...
For Android, the name must match the Adapter names from the [Android Adapters table](https://github.com/cleveradssolutions/CAS-Android/blob/master/Adapters/README.md). Below, as an example, only GoogleAds, CASExchange, and DTExchange are shown.
...
For iOS, the name must match the Adapter names from the [iOS Adapters table](https://github.com/cleveradssolutions/CAS-Android/blob/master/Adapters/README.md). Below, as an example, only GoogleAds, CASExchange, and DTExchange are shown.
