...
```ruby
  ...
  pod 'CASMediationYangoAds'
  pod 'CASMediationYsoNetwork'
  pod 'CASMediationMaticoo'
  pod 'CASMediationSmaato'
  pod 'CASMediationVerve'
```

<Info>
Read more about the adapter versions [here](https://github.com/cleveradssolutions/CAS-iOS/blob/master/Adapters/README.md).
</Info>
...
```ruby
  pod 'CASMediationPubMatic'
  pod 'CASMediationDisplayIO'
  pod 'CASMediationBidease'
  pod 'CASMediationMoloco'
  pod 'CASMediationMonetrix'
```
