...
- [Enable test ad mode](Unreal/Enabling-test-ads#enable-test-ad-mode) for all devices.
- [Set device ids to test ad](Unreal/Enabling-test-ads#enable-test-devices).
...
1. In your Unity project, navigate to `Edit > Project Settings > Plugins > CAS.AI Config - [Platform]` to create and modify default settings for each native platform.
2. Enable Test Ad mode.
3. Use any no empty Manager ID. For example `demo` or your CAS Manager ID.

<Image width="650" alt="image" src="/assets/unreal/Enabling-test-ads-3.png" />

<Warning>  
Make sure you disable test ad mode and replace test App ID with your own ad CAS ID before publishing your app!
</Warning>
...
4. Modify project settings to set the test device ID.

<Info>
Be sure to remove the test devices before you release your app.
</Info>
