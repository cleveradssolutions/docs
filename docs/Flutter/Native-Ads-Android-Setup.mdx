...
Please review the description and requirements of native ad assets on [CAS Android wiki page](Android/Native-Ad-assets).
</Info>
</Step>
...
You can find more details about the implementation of platform native ad view on the [CAS Android wiki page](Android/Display-Native-Ad#manual-display-native-ad).
</Step>
