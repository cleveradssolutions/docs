---
title: App Open Ads
description: This guide explains how to integrate app open ads into a Flutter app.
---
...
```dart
  @override
  void dispose() {
    _appOpenAd.dispose(); // [!code highlight]
    super.dispose();
  }
```
...
## Complete example
- [AppOpen ad example](https://github.com/cleveradssolutions/CAS-Flutter/blob/main/example/lib/main.dart#L74)
