...
description: This guide explains how to integrate interstitial ads into a Flutter app.
---
...
```dart
  @override
  void dispose() {
    _interstitialAd.dispose(); // [!code highlight]
    super.dispose();
  }
```
...
## Complete example
- [Interstitial ad example](https://github.com/cleveradssolutions/CAS-Flutter/blob/main/example/lib/main.dart#L131)
