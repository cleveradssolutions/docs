...
class MyActivity : Activity() {
    ...
    private val appOpenAd = CASAppOpen(MyApplication.CAS_ID)
...
override fun onCreate(savedInstanceState: Bundle?) {
    ...
    appOpenAd.contentCallback = adContentCallback
    appOpenAd.load(this)
}
```
...
<CodeGroup synchronize="true">
```kotlin
appOpenAd.placement = "BestPlace"
```

```java
appOpenAd.setPlacement("BestPlace")
```
</CodeGroup>
