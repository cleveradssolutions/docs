...
class MyActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bannerView.size = AdSize.BANNER // or any AdSize from above
...
class MyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bannerView.setSize(AdSize.BANNER); // or any AdSize from above
...
override fun onConfigurationChanged(newConfig: Configuration) {
    ...
    bannerView.size = AdSize.BANNER // or compute new AdSize for the orientation
...
public void onConfigurationChanged(Configuration newConfig) {
    super.onConfigurationChanged(newConfig);
    bannerView.setSize(AdSize.BANNER); // or compute new AdSize for the orientation
    if (bannerView.isAutoloadEnabled() == false) {
        bannerView.load();
    }
}
