...
## Override A/B Test group
Override live A/B test group.
```bash
adb shell setprop debug.clever.ads.solutions.abtest TEST_NAME
```

To disable override test group, use the following command:
```bash
adb shell setprop debug.clever.ads.solutions.abtest .
```

<Info>Introduced with CAS 4.6.7.</Info>
