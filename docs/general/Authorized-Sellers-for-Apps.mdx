---
title: Authorized Sellers for Apps (App-ads.txt)
---
...
- **Combined file** containing sources from all mediation partners: [app-ads.txt](https://github.com/cleveradssolutions/App-ads.txt/blob/main/app-ads.txt)  
- **File-separated sources** for each partner can be found in: [Networks](https://github.com/cleveradssolutions/App-ads.txt/tree/main/Networks)  

You can conveniently use our domain https://cas.ai as the **Developer Website** for your app, and rest assured that https://cas.ai/app-ads.txt will always be kept up to date.

<Card title="Subscribe" icon="github" href="https://github.com/cleveradssolutions/App-ads.txt/subscription">
...
<Tabs>
<TabItem label="AppStore" value="appstore">
...
<TabItem label="GooglePlay" value="googleplay">
